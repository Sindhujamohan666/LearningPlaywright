...
```
Error: locator.click: Error: strict mode violation: getByTestId('item-test-allthethings-tshirt-red-title-link').or(locator('.item-name')) resolved to 6 elements:
    1) <div class="item-name" data-test="inventory-item-name">…</div> aka locator('div').filter({ hasText: /^Test\.allTheThings\(\) T-Shirt \(Red\)$/ })
    2) <div class="item-name" data-test="inventory-item-name">…</div> aka locator('div').filter({ hasText: /^TTA Bike Light$/ })
    3) <div class="item-name" data-test="inventory-item-name">…</div> aka locator('div').filter({ hasText: /^TTA Bolt T-Shirt$/ })
    4) <div class="item-name" data-test="inventory-item-name">…</div> aka locator('div').filter({ hasText: /^TTA Fleece Jacket$/ })
    5) <div class="item-name" data-test="inventory-item-name">…</div> aka locator('div').filter({ hasText: /^TTA Junior Tester Onesie$/ })
    6) <div class="item-name" data-test="inventory-item-name">…</div> aka locator('div').filter({ hasText: /^TTA Practice Backpack$/ })

Call log:
  - waiting for getByTestId('item-test-allthethings-tshirt-red-title-link').or(locator('.item-name'))
...
```ts
  ...
  10 |         this.page=page;
  11 |         this.selectitem=page.getByTestId('item-test-allthethings-tshirt-red-title-link').or(page.locator('.item-name'));
