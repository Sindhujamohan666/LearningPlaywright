    ...
    - generic [ref=e73]:
      - generic [ref=e76]:
        - iframe [ref=e78]: "<span data-mce-type=\"bookmark\" style=\"display: inline-block; width: 0px; overflow: hidden; line-height: 0;\" class=\"mce_SELRES_start\"> </span>Loading…":
          - generic [ref=f1e4]:
            - link "Webinar How to find a test strategy that works in real QA teams Attend" [ref=f1e5] [cursor=pointer]:
              - /url: https://shiftsync.tricentis.com/events/how-to-find-a-test-strategy-that-works-in-real-qa-teams-119?utm_source=ssnetwork&utm_medium=multi&utm_term=SH&utm_content=TestStrategy
              - generic [ref=f1e6]: Webinar
              - generic [ref=f1e9]:
                - img [ref=f1e10]
                - text: How to find a test strategy that works in real QA teams
              - generic [ref=f1e12]:
                - paragraph [ref=f1e13]: Attend
                - img [ref=f1e15]
            - link "Why Companies Prefer CP-SAT Experts Register Now" [ref=f1e16] [cursor=pointer]:
              - /url: https://cpsat.agiletestingalliance.org
              - generic [ref=f1e19]:
                - img [ref=f1e20]
                - text: Why Companies Prefer CP-SAT Experts
              - generic [ref=f1e22]:
                - paragraph [ref=f1e23]: Register Now
                - img [ref=f1e25]
            - link "#1 Free Test Management Tool with A.I. is here Explore" [ref=f1e26] [cursor=pointer]:
          ...
          - generic [ref=e189]:
            - generic [active] [ref=e190]:
              ...
              - textbox "user name field" [ref=e193]:
                ...
                - text: sindhu
              - img [ref=e194]
              - textbox "Enter pizza name" [ref=e197]: Paneer
                ...
                - generic [ref=f2e8]:
                  ...
                  - generic [ref=f2e16]:
                    - link "Sign in to Google" [ref=f2e17] [cursor=pointer]:
                      - /url: https://accounts.google.com/Login?continue=https%3A%2F%2Fdocs.google.com%2Fforms%2Fd%2Fe%2F1FAIpQLSeguyGBfogdUO6IRfxJapNxTJQTaAEWYfcd5984L0T_q-0Syg%2Fviewform%3Ffbzx%3D7298884790595153802
...
```ts
  ...
  5  |   
  6  |   //Fill the form inside shadow DOM 
  7  |   //Fill username
  8  |   await page.locator('#kils').fill('sindhu');
  9  |   //Fill pizza
  10 |   await page.locator('#pizza').fill('Paneer');
  11 |   //Fill training
> 12 |   await page.locator('#training').fill('training 1');
     |                                   ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  13 | 
  14 |   //Fill password 
  15 |   await page.locator('#pwd').fill('12345');
  16 | })
  17 |    
```