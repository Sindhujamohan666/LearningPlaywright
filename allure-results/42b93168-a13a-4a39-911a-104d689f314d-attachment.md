...
Call log:
  - waiting for locator('#pact1').first().contentFrame().locator('h1')
        ...
        - generic [ref=f1e1]:
          - generic [ref=f1e7]:
            ...
            - iframe [active] [ref=f1e12]:
              - generic [ref=f3e1]:
                - generic [ref=f3e7]:
                  - textbox "Current Crush Name" [ref=f3e8]: Wife
                  - button "Connect now" [ref=f3e9]
                  - heading "Heaven is here" [level=4] [ref=f3e10]
                  - iframe [active] [ref=f3e11]:
                    - generic [ref=f4e1]:
                      - generic [ref=f4e7]:
                        - textbox "Destiny" [active] [ref=f4e8]: Playwright
                        - button "Close it" [ref=f4e9]
                      - generic [ref=f4e10]: mobile
...
```ts
  ...
  6  | 
  7  |     let frame1: FrameLocator = page.frameLocator('#pact1').first();
  8  |     let frame2:FrameLocator=frame1.frameLocator('#pact2');
  9  |     let frame3:FrameLocator=frame2.frameLocator('#pact3');
  10 |     
  11 |     await frame1.getByTitle('Enter your first crush name');
  ...
  15 | 
> 16 |     const headerText=await frame1.locator('h1').innerText();
     |                                                 ^ Error: locator.innerText: Test timeout of 30000ms exceeded.
