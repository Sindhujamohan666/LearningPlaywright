...
- Name: 19_Data_Driven_Testing\266_DDT_CSV.spec.ts >> DDT CSV >> Login with : locked account
...
Locator: getByText('Account is locked')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Account is locked')
