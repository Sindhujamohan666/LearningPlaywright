...
Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Add to cart' }) resolved to 6 elements:
    1) <button type="button" class="item-btn" data-product="test-allthethings-tshirt-red" data-test="add-to-cart-test-allthethings-tshirt-red">Add to cart</button> aka locator('[data-test="add-to-cart-test-allthethings-tshirt-red"]')
    2) <button type="button" class="item-btn" data-product="tta-bike-light" data-test="add-to-cart-tta-bike-light">Add to cart</button> aka locator('[data-test="add-to-cart-tta-bike-light"]')
    3) <button type="button" class="item-btn" data-product="tta-bolt-tshirt" data-test="add-to-cart-tta-bolt-tshirt">Add to cart</button> aka locator('[data-test="add-to-cart-tta-bolt-tshirt"]')
    4) <button type="button" class="item-btn" data-product="tta-fleece-jacket" data-test="add-to-cart-tta-fleece-jacket">Add to cart</button> aka locator('[data-test="add-to-cart-tta-fleece-jacket"]')
    5) <button type="button" class="item-btn" data-product="tta-junior-tester-onesie" data-test="add-to-cart-tta-junior-tester-onesie">Add to cart</button> aka locator('[data-test="add-to-cart-tta-junior-tester-onesie"]')
    6) <button type="button" class="item-btn" data-product="tta-practice-backpack" data-test="add-to-cart-tta-practice-backpack">Add to cart</button> aka locator('[data-test="add-to-cart-tta-practice-backpack"]')
...
```ts
  ...
  10 |         this.page=page;
  11 |         this.selectitem=page.getByRole('button',{name:'Add to cart'});
...
> 16 |         await this.selectitem.click();
     |                               ^ Error: locator.click: Error: strict mode violation: getByRole('button', { name: 'Add to cart' }) resolved to 6 elements:
