...
```
Error: locator.click: Error: strict mode violation: locator('div[class=\'item-name\']>a') resolved to 6 elements:
    1) <a data-test="item-test-allthethings-tshirt-red-title-link" href="./inventory-item.html?id=test-allthethings-tshirt-red">Test.allTheThings() T-Shirt (Red)</a> aka locator('[data-test="item-test-allthethings-tshirt-red-title-link"]')
    2) <a data-test="item-tta-bike-light-title-link" href="./inventory-item.html?id=tta-bike-light">TTA Bike Light</a> aka locator('[data-test="item-tta-bike-light-title-link"]')
    3) <a data-test="item-tta-bolt-tshirt-title-link" href="./inventory-item.html?id=tta-bolt-tshirt">TTA Bolt T-Shirt</a> aka locator('[data-test="item-tta-bolt-tshirt-title-link"]')
    4) <a data-test="item-tta-fleece-jacket-title-link" href="./inventory-item.html?id=tta-fleece-jacket">TTA Fleece Jacket</a> aka locator('[data-test="item-tta-fleece-jacket-title-link"]')
    5) <a data-test="item-tta-junior-tester-onesie-title-link" href="./inventory-item.html?id=tta-junior-tester-onesie">TTA Junior Tester Onesie</a> aka locator('[data-test="item-tta-junior-tester-onesie-title-link"]')
    6) <a data-test="item-tta-practice-backpack-title-link" href="./inventory-item.html?id=tta-practice-backpack">TTA Practice Backpack</a> aka locator('[data-test="item-tta-practice-backpack-title-link"]')

Call log:
  - waiting for locator('div[class=\'item-name\']>a')
