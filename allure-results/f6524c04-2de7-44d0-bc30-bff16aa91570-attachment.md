...
- Name: 09_Frames_IFrame\241_IFrame_Within_IFrame.spec.ts >> frame within frame
- Location: tests\09_Frames_IFrame\241_IFrame_Within_IFrame.spec.ts:4:5
...
```ts
  ...
  2  | 
  3  | 
  4  | test('frame within frame',async({page})=>{
...
> 11 |      await frame1.locator('#inp_val').fill('Aishwarya Rai');
  ...
  14 | 
  15 |     const headerText=await frame1.locator('h1').innerText();
